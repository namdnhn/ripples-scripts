...
def getNClosest():
    ...
    with open('allRelevantNodes.txt') as f:
        for line in f:
            nodeToDescendants['('+str(line.strip())+')'] = {}
            nodeToDescendantsPlusOne['('+str(line.strip())+')'] = {}
            nodeToDescendantsPlusTwo['('+str(line.strip())+')'] = {}
            nodeToDescendantsPlusThree['('+str(line.strip())+')'] = {}
    ...
    open('allRelevantNodesToDescendants.txt','w').write(myOutString)
    open('allDescendants.txt','w').write(allDescendants)
